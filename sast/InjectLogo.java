...
public class InjectLogo extends JFrame
{
	...
	//	jp.setBounds(150,210,600,300);
		...
		class HandleAE implements ActionListener
        {
        	public void actionPerformed(ActionEvent ae)
        	{
        		...
        		{
        		try
				{	String xxx = "call batch/sast/injectlogo/enable.bat";
        		...
        		try
				{
					String xxx = "call batch/sast/injectlogo/disable.bat";
					Runtime.getRuntime().exec("cmd /c start "+xxx);
					}
					catch(Exception e)
						{
