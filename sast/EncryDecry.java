...
public class EncryDecry extends JFrame
{
	...
	//	jp.setBounds(150,210,600,300);
		...
		class HandleAE implements ActionListener
        {
        	public void actionPerformed(ActionEvent ae)
        	{
        		...
        		{
        		try
				{	String xxx = "call batch/security/encryption/enable.bat";
        		...
        		try
				{
					String xxx = "call batch/security/encryption/disable.bat";
					Runtime.getRuntime().exec("cmd /c start "+xxx);
					}
					catch(Exception e)
						{
