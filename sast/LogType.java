...
public class LogType extends JFrame
{
	...
	//	jp.setBounds(150,210,600,300);
		...
		b1=new JButton(new ImageIcon("./Images/classic.png"));
		b1.setBounds(50,180,120,50);

		b2=new JButton(new ImageIcon("./Images/startButtonxp.png"));
		...
		class HandleAE implements ActionListener
        {
        	public void actionPerformed(ActionEvent ae)
        	{
        		...
        		{
        		try
				{	String xxx = "call batch/logon/logontype/classic.bat";
        		...
        		try
				{
					String xxx = "call batch/logon/logontype/xp.bat";
					Runtime.getRuntime().exec("cmd /c start "+xxx);
					}
					catch(Exception e)
						{
